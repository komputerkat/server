	...
	override void StartingEquipSetup(PlayerBase player, bool clothesChosen)
	{
		...
		if(player.IsMale())
		{
			...
			switch (Math.RandomInt(0, 30)) 
			{
				...
				case 9: male = hunterClass(player); break;
				case 10: male = hunterClass(player); break;
				case 11: male = hunterClass(player); break;
				case 12: male = hunterClass(player); break;
				case 13: male = hunterClass(player); break;
		...
		else
		{
			...
			switch (Math.RandomInt(0, 30)) 
			{
				...
				case 9: female = hunterClass(player); break;
				case 10: female = hunterClass(player); break;
				case 11: female = hunterClass(player); break;
				case 12: female = hunterClass(player); break;
				case 13: female = hunterClass(player); break;
