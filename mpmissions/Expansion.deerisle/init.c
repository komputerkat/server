...
class CustomMission: MissionServer
{
	...
	override void StartingEquipSetup(PlayerBase player, bool clothesChosen)
	{
		...
		if ( itemTop )
		{
			...
			SetRandomHealth(itemEnt);
			player.GetInventory().CreateInInventory("MVS_SlingPack_Tan");    // added items
			...
			player.GetInventory().CreateInInventory("TWP_Glock17");    // added items
			player.GetInventory().CreateInInventory("TWP_Glock17_mag_19Rnd");    // added items
			player.GetInventory().CreateInInventory("BandageDressing");    // added items
			player.GetInventory().CreateInInventory("SpaghettiCan");    // added items
