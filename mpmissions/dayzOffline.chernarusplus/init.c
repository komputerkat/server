...
class CustomMission: MissionServer
{
	...
	override void StartingEquipSetup(PlayerBase player, bool clothesChosen)
	{
		...
		if ( itemClothing )
		{
			...
			SetRandomHealth( itemEnt );
			player.GetInventory().CreateInInventory("DryBag_Blue");    // added items
			...
			player.GetInventory().CreateInInventory("CZ75");    // added items
			player.GetInventory().CreateInInventory("Mag_CZ75_15Rnd");    // added items
